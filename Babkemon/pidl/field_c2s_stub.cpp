...
#include "field_c2s_stub.h"


const unsigned char sz_field_c2s_stub_hRmi[] = 
...
namespace field_c2s {
	...
	bool Stub::ProcessReceivedMessage(::Proud::CReceivedMessage &pa, void* hostTag) 
	{
#ifndef __FreeBSD__ 
		{
			...
			unsigned char x = sz_field_c2s_stub_hRmi[0]; 
			x++; 
		}
#endif
			...
			case Rmi_MoveCharacter:
				{
					...
					mgg::babkemon::field::CharacterMovePacket packet; __msg >> packet;
					m_core->PostCheckReadMessage(__msg,RmiName_MoveCharacter);
					...
					if(m_enableNotifyCallFromStub && !m_internalUse)
					{
						...
						NotifyCallFromStub(remote, (::Proud::RmiID)Rmi_MoveCharacter, 
							RmiName_MoveCharacter,parameterString);
			
			#ifdef VIZAGENT
						m_core->Viz_NotifyRecvToStub(remote, (::Proud::RmiID)Rmi_MoveCharacter, 
							RmiName_MoveCharacter, parameterString);
			#endif
					}
					...
					if(!m_internalUse && m_enableStubProfiling)
					{
						...
						summary.m_rmiID = (::Proud::RmiID)Rmi_MoveCharacter;
						summary.m_rmiName = RmiName_MoveCharacter;
					...
					if(__ret==false)
					{
						...
						m_core->ShowNotImplementedRmiWarning(RmiName_MoveCharacter);
					}
...
__fail:
	...
	const PNTCHAR* Stub::RmiName_MoveCharacter =_PNT("MoveCharacter");
	#else
	const PNTCHAR* Stub::RmiName_MoveCharacter =_PNT("");
	#endif
	const PNTCHAR* Stub::RmiName_First = RmiName_MoveCharacter;
